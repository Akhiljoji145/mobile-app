        ...
        <Stack.Navigator screenOptions={{ animation: 'fade', headerShown: false }}>
          {user ? (
            user.is_superuser ? (
              ...
              <Stack.Screen name="TeacherRoot">
                {props => <TeacherNavigator {...props} user={user} onLogout={handleLogout} />}
              </Stack.Screen>

            ) : user.is_parent ? (
              <Stack.Screen name="ParentRoot">
                {props => <ParentNavigator {...props} user={user} onLogout={handleLogout} />}
              </Stack.Screen>
